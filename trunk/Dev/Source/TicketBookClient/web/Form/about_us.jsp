...
<font class="_content_title">About us</font>
    <img src="<%=request.getContextPath()%>/CompanyImages/smallbusiness_ticket.jpg" alt="business" align="left" style="padding-right:10px">

    <b style="font-size:14px">In today's busy world</b>, people find it hard to find the time for entertainment. It is really pretty time consuming to find out the various entertainment shows/movies and any other such shows in and around the city. And on the top of it is more irritating to go physically and book the ticket.
