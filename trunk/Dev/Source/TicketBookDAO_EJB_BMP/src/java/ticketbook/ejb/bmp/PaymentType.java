...
import ticketbook.ejb.bmp.dao.PaymentTypeDAO;
 ...
 * @author Admin
 */
public class PaymentType extends PaymentTypeTransferData implements EntityBean {
    ...
    public void ejbLoad() {
        try {
            ...
            PaymentTypeTransferData data = PaymentTypeDAO.getInstance(SQLTicketBookConnection.getInstance()).getPaymentTypeByID(this.getID());
            if(data!=null){
    ...
    public Collection ejbFindAll() throws FinderException{
        try {
           return PaymentTypeDAO.getInstance(SQLTicketBookConnection.getInstance()).getPaymentTypeIDs();
        } catch (SQLTicketBookException ex) {
            ex.printStackTrace();
        }
